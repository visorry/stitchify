      ...
      <div className="container mx-auto px-6 sm:px-12 lg:px-20">
        {/* <div className="text-center mb-16">
          ...
          <p className="text-gray-600 max-w-2xl mx-auto">
            Discover the talented artisans behind our unique pieces. Each
            creator brings their own style and expertise to our marketplace.
          </p>
        </div>
          ...
          {creators.map((creator) => (
            ...
            >
              ...
              <div className="flex justify-between items-center">
                ...
                <button
                  className="px-6 py-2 bg-emerald-50 text-emerald-600 rounded-full text-sm font-medium
